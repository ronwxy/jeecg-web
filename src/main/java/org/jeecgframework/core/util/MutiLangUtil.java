...
public class MutiLangUtil {
    ...
    public static String paramDelSuccess(String paramLangKey) {
        String message = getLang("common.delete.success.param", paramLangKey);
        return message;
    }
    ...
    public static String paramDelFail(String paramLangKey) {
        String message = getLang("common.delete.fail.param", paramLangKey);
        return message;
    }
    ...
    public static String paramUpdSuccess(String paramLangKey) {
        String message = getLang("common.edit.success.param", paramLangKey);
        return message;
    }
     ...
     */
    public static String paramUpdFail(String paramLangKey) {
        String message = getLang("common.edit.fail.param", paramLangKey);
        return message;
    }
    ...
    public static String paramAddSuccess(String paramLangKey) {
        String message = getLang("common.add.success.param", paramLangKey);
        return message;
    }
    ...
    public static void setMutiTree(List<?> treeList) {
        ...
        for (Object treeItem : treeList) {
            ...
            //treeItem.getText();
            String langKey = (String) reflectHelper.getMethodValue("text");
            String langContext = getLang(langKey);
     ...
     */
    public static boolean existLangKey(String langKey) {
        String langContext = ResourceUtil.getMutiLan(langKey + "_" + "zh-cn");
     ...
     * @return 如果存在则返回true，否则false
     */
    public static boolean existLangKey(String langKey, String langCode) {
        String langContext = ResourceUtil.getMutiLan(langKey + "_" + langCode);
        if (oConvertUtils.isNotEmpty(langContext)) {
            return true;
        }
        return false;
    ...
    public static void setMutiLangValueForList(List<Object> list, String... attributes) {
        ...
        for (Object obj : list) {
            ...
            for (String attribute : attributes) {
                String langKey = (String) reflectHelper.getMethodValue(attribute);
                String langContext = getLang(langKey);
                reflectHelper.setMethodValue(attribute, langContext);
            }
