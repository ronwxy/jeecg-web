...
//          String type = origDescriptors[i].getPropertyType().toString();
     ...
     * @throws InvocationTargetException
     */
    public static void copyMap2BeanNobig(Object bean, Map properties) throws
            IllegalAccessException, InvocationTargetException {
        // Do nothing unless both arguments have been specified
        if ((bean == null) || (properties == null)) {
            return;
...
//              }
     ...
     * @param source         属性来源
     * @param target         目标
     * @param copyProperties 需要复制的属性
     * @throws BeansException
     */
    public static void copyBeanProperties(Object source, Object target, String... copyProperties) throws BeansException {
