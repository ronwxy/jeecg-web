...
public class SendMailUtil {
    ...
    private static final String FROM_NAME = "测试公司";
    private static final String CHAR_SET = "utf-8";
    private static final String USER_NAME = "zhangdh@163.com";
    ...
    public static void sendFtlMail(String toMailAddr, String subject,
        ...
        try {
            ...
            hemail.setCharset(CHAR_SET);
            hemail.addTo(toMailAddr);
            hemail.setFrom(FROM, FROM_NAME);
            hemail.setAuthentication(USER_NAME, PASSWORD);
