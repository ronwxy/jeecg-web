            ...
            <#if po.replace??>
	    		<div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="input-group" style="width:100%">
                        <select class="form-control input-sm" id="${po.field?replace("_","\\.")}"
                                name="${po.field?replace("_","\\.")}">
                ...
                <#if po.dictionary?index_of(",")!=-1&&po.popup>
					...
					<#assign columnArray = '${po.dictionary}'?split(",")>
                            <input type="text" class="form-control input-sm" id="${po.field}" name="${po.field}"
                                   onclick="popupClick(this,'${columnArray[2]?replace('@',',')}','${columnArray[1]?replace('@',',')}','${columnArray[0]}')">
