...
<div id="w" scroll="no" class="easyui-window" data-options="closed:true,
 resizable:false, title:'高级查询构造器'" style="width: 880px; height: 400px; padding: 0px;">
    <div class="easyui-layout" fit="true">
            ...
            <div style="float: left;">
                <div style="float: left; top: 1px">
                    <ul id="dsUL">
						...
						<span>
							<input id="citySel" name="cons[0].tree" onclick="treeClick(this)" type="text"
                                   style="width:120px;" class=" queryTree" readonly="readonly"/> &nbsp;
						...
						<input id="conValue" name="cons[0].val" type="text" style="width:165px;"
        ...
        <div data-options="region:'south',border:false"
            ...
            <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)"
               onclick="javascript:mySearch()">查询</a>
    ...
    <div id="menuContent" class="menuContent"
         style="display:none; position: absolute;background:#FFF;overflow:auto;height:120px;border:1px solid #9a848445;">
    ...
    <ul id="dsUL_template" style="display:none">
        <li class="conditions oop" data-index="#index#">
					<span>
						<input name="cons[#index#].tree" onclick="treeClick(this)" type="text" style="width:120px;"
                               class="tree queryTree" readonly="readonly"/> &nbsp;
            ...
            <span class="spanVal" style="position: relative; z-index: 2000;">
						<input id="conValue1" name="cons[#index#].val" style="width:165px;" type="text"
                               class="text conditionValue" title="">
					</span>
            <span>
						<a id="add" href="javascript:addULChild()" class="fa fa-plus-square" title="添加一个新的过滤条件"
             ...
             success: function (data) {
                 if ("input" == data.obj[0].stype) {
                     ...
                     $("input[name='cons[" + i + "].val']").css({
                         "background": "url(\"plug-in/diy/icons/search.png\") no-repeat 140px",
                         "width": "165px"
                     });
                 }
             },
