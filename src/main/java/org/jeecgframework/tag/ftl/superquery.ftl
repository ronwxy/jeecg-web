...
<span style="display:none;">
		<#list fields as column>		
			<#if column.formatter??>
				<span id="field_${column.field}">
					<input id="conValue1" name="cons[#index#].val" type="text" style="width:130px;"
                           onclick="WdatePicker({dateFmt:'${column.formatter}'})" class="Wdate text conditionValue"
                           title="">
				</span>
            ...
            <#else>
				<span id="field_${column.field}"><input id="conValue1" name="cons[#index#].val" type="text"
