            ...
            <#-- 内容开始  style="border-right:1px solid #ddd" -->
                ...
                <#-- 左侧-begin -->
                    <div class="left-div col-sm-9 col-md-9">
                        ...
                        <#-- 过滤条件匹配 and/or -->
                            <select id="anyallSelect" name="mchtyp" style="width: 200px"
                                    class="select form-control input-sm">
                        ...
                        <div class="left-content">
                            <table id="superQueryCondition">
                                <tr>
                                    <td>
                                    <#-- 字段选择 -->
                                        <select class="field form-control input-sm" id="field" name="cons[0].fld"
                                                style="width:140px" onchange="setConsModel(this)">
                                            <option value="">&nbsp;</option>
							<#list fields as column>
                                <#if '${column.hidden?string("true", "false")}' != "true">
									<option value="${column.field}" data-popup="${column.popup?string}"
                                            data-dictionary="${column.dictionary!}">${column.title!}</option>
                                </#if>
                            </#list>
                                        </select>
                                    </td>
                                    <td>
                                    <#-- 条件选择 -->
                                        <select id="condition" name="cons[0].ctyp"
                                                class="compareType form-control input-sm"
                                                style="width: 140px;margin: 1px;">
                                            <option value="">&nbsp;</option>
                                    ...
                                    <td class="convaltd">
                                    <#-- 值录入 -->
                                        <input name="cons[0].val" type="text"
                                               class="text conditionValue form-control input-sm" title=""
                                               style="width:140px;">
                                    </td>
                                    <td>
                                    <#-- 操作列 -->
                                        <a href="javascript:void(0);" onclick="addOneRow()" class="fa fa-plus-square"
                                           title="添加一个新的过滤条件" style="margin-left:8px;"></a>
                                        <a href="javascript:void(0);" onclick="delOneRow(this)"
                                           class="fa fa-minus-square" title="删除此过滤条件" style="margin-left:10px;"></a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion"
                                       href="#queryRecords" aria-expanded="true" aria-controls="collapseOne">
                                        查询历史
                                    </a>
                                </h4>
                            </div>
                            <div id="queryRecords" class="panel-collapse collapse in" role="tabpanel"
...
<table style="display:none" id="superQueryConditionTemplate">
    <tr>
        <td>
            <select class="field form-control input-sm" id="field" name="cons[#index#].fld" style="width:140px"
        ...
        <td>
            <select id="condition" name="cons[#index#].ctyp" class="compareType form-control input-sm"
                    style="width: 140px;margin: 1px;">
                <option value="">&nbsp;</option>
                <option value="=">等于</option>
                <option value="!=">不等于</option>
        ...
        <td class="convaltd">
            <input name="cons[#index#].val" type="text" class="text conditionValue form-control input-sm" title=""
                   style="width:140px;">
        </td>
        <td>
            <a href="javascript:void(0);" onclick="addOneRow()" class="fa fa-plus-square" title="添加一个新的过滤条件"
               style="margin-left:8px;"></a>
            <a href="javascript:void(0);" onclick="delOneRow(this)" class="fa fa-minus-square" title="删除此过滤条件"
	...
	<#list fields as column>		
		<#if column.formatter??>
			<span id="field_${column.field}">
				<input name="cons[#index#].val"
                       data-format="<#if column.formatter?length gt 10>datetime<#else>date</#if>" type="text"
                       style="width:140px;" class="layerdate text conditionValue form-control input-sm" title="">
			</span>
        ...
        <#else>
			<span id="field_${column.field}"><input name="cons[#index#].val" type="text"
                                                    class="text conditionValue form-control input-sm" title=""
