...
<![endif]-->
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#${config_id}List').datagrid('getPager').pagination({
                beforePageText: '',
                afterPageText: '/{pages}',
    ...
    <div id="gallery_tools">
        <div class="gallery_tool">
            <div class="gallery_too">
                开启动画:<input name="animate" type="checkbox" id="gallery_animate" class="gallery_check"
                            checked="checked"/>
            </div>
            <div class="gallery_too">
            ...
            <div class="gallery_too">
                <a href="javascript: void(0);" title="download chart" target="_blank" download="chart.png"
                   id="download_a">
    ...
    <div style="margin-top:4px;">
        ...
        <span>
				<table class='form_table' id='data_table'>
					...
					<tbody id='form_tbody'>
						<tr id='form_tr_head'><td><input type="text" class="form_text"/></td><td><input type="text"
                                                                                                        class="form_text"/></td><td
                                class="td_color"><input type="text" class="form_text"/></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
					</tbody>
				</table>
			</span>
    </div>
