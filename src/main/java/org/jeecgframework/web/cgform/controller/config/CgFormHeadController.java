...
//			columnList.add(field);
     ...
     *
     * @param id 配置id
     * @param sqlPlugin 插件内容
     * @param request
     * @return
     */
    @RequestMapping(params = "sqlPluginSave")
    @ResponseBody
    public AjaxJson sqlPluginSave(String id, String sqlPlugin, HttpServletRequest request) {
        String message = "";
        CgFormHeadEntity bean = cgFormFieldService.getEntity(
                CgFormHeadEntity.class, id);
    ...
    @ResponseBody
    public AjaxJson jsPluginSave(String id, String jsPlugin, HttpServletRequest request) {
        String message = "";
        CgFormHeadEntity bean = cgFormFieldService.getEntity(
                CgFormHeadEntity.class, id);
