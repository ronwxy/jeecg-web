...
public class GenerateController extends BaseController {
    ...
    public ModelAndView gogenerate(CgFormHeadEntity cgFormHead, HttpServletRequest request) {
        ...
        if (cgFormHead.getJformType() == 1 || cgFormHead.getJformType() == 3) {
            ...
            // 默认新一代模板(IE10+/移动支持/Bootstrap/Vue/支持原生态列表)
            request.setAttribute("jspModeList", GenerateUtil.getOnlineGenerateEnum("single", "ext-common", "Y".equals(cgFormHead.getIsTree())));
            ...
            // 默认新一代模板(IE10+/移动支持/Bootstrap/Vue/支持原生态列表)
            request.setAttribute("jspModeList", GenerateUtil.getOnlineGenerateEnum("onetomany", "ext-common", "Y".equals(cgFormHead.getIsTree())));
