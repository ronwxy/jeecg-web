...
public class TSInterfaceDdataRuleEntity extends AbstractIdEntity implements Serializable {
     ...
     * 权限接口
     */
    private TSInterfaceEntity tsInterfaceEntity = new TSInterfaceEntity();
    ...
    public String toString() {
        ...
        builder.append(tsInterfaceEntity);
