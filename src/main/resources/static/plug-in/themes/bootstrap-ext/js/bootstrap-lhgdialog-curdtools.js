 ...
 * @param saveurl
 */
function openuploadwin(title, url, name, width, height, callbackFunc) {
    gridname = name;
    $.dialog({
        content: 'url:' + url,
        zIndex: getzIndex(),
...
function listFileImgFormat(value, type) {
    ...
    var value1 = (window.IMG_SHOW_AND_DOWN_URL || "img/server/") + value;
    if ("image" == type) {
        ...
        if (value.indexOf(".jpg") > -1 || value.indexOf(".gif") > -1 || value.indexOf(".png") > -1) {
            ...
            var value2 = (window.IMG_SHOW_AND_DOWN_URL || "img/server/") + value + "?down=true&response-content-type=application%2Foctet-stream";
