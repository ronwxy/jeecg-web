...
(function () {
    ...
    if (!window.webRoot) {
        window.webRoot = "cnbots";
        console.log("请在对应jsp页面加入:<script type=\"text/javascript\">window.webRoot = \"${pageContext.request.contextPath}\";</script>");
    }
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        imagePath: window.IMG_SHOW_AND_DOWN_URL || (window.webRoot + "/img/server/upload/files/")
        ...
        filePath: window.IMG_SHOW_AND_DOWN_URL || (window.webRoot + "/img/server/upload/files/")
        ...
        imageManagerPath: window.IMG_SHOW_AND_DOWN_URL || (window.webRoot + "/img/server/upload/files/")
        ...
        videoPath: window.IMG_SHOW_AND_DOWN_URL || (window.webRoot + "/img/server/upload/files/")
