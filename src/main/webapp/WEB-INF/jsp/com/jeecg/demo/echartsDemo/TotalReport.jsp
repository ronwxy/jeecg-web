...
<t:datagrid name="TotalReportList" title="broswer.count.statistics" actionUrl="jeecgListDemoController.do?listAllStatisticByJdbc"  fitColumns="true" idField="id" fit="true">
		...
		<t:dgCol title="lang.broswer" field="broswer" width="130"/>
		<t:dgCol title="number.broswer" field="broswercount" width="130"/>
		<t:dgCol title="common.proportion" field="rate" width="130"/>
	</t:datagrid>
</div>