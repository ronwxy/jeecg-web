			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tbody>
					<tr>
						...
						<td class="value">
							<t:dictSelect field="demos[0].sex" typeGroupCode="sex" title="性别"/>
						</td>
						<td class="value">
						     	 <input id="salary" name="demos[0].salary" type="text" class="inputxt" value="">
						</td>
						<td class="value">
							<t:dictSelect field="demos[0].status" typeGroupCode="sf_yn" title="入职状态"/>
						</td>
					</tr>
					<tr>
						<td class="value">							
						...
						<td class="value">
							<t:dictSelect field="demos[1].sex" typeGroupCode="sex" title="性别"/>
						</td>
						<td class="value">
						     	 <input id="salary" name="demos[1].salary" type="text" class="inputxt" value="">
						</td>
						<td class="value">
							<t:dictSelect field="demos[1].status" typeGroupCode="sf_yn" title="入职状态"/>
						</td>
					</tr>
				</tbody>
			</table>		
