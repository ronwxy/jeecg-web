...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		<t:datagrid name="jeecgDemoListquery" title="高级查询示例"
			...
			<t:dgCol title="用户名" popup="true" dictionary="user_msg,name,realname" field="name" query="true"/>
			<t:dgCol title="个人介绍" field="content"/>
			<t:dgCol title="办公电话" field="phone" query="true"/>
			<t:dgCol title="创建日期" field="createDate" formatter="yyyy-MM-dd"/>
			<t:dgCol title="邮箱" field="email"/>
			<t:dgCol title="年龄" sortable="true" field="age"/>
			<t:dgCol title="工资" field="salary" query="true"/>
			<t:dgCol title="生日" field="birthday" formatter="yyyy-MM-dd" query="true" />
			<%-- <t:dgToolBar operationCode="add" title="高级查询" icon="icon-search" funname="queryBuilder"/> --%>
		</t:datagrid>
	</div>
</div>