...
<div region="center" style="padding:0px;border:0px">
	<t:datagrid name="functionDemoList" title="menu.manage" actionUrl="jeecgFormDemoController.do?functionGrid" idField="id" treegrid="true" pagination="true" pageSize="5">
        ...
        <t:dgCol title="menu.name" field="functionName" treefield="text" width="20"/>
        <t:dgCol title="common.icon" field="TSIcon_iconPath" treefield="code" image="true" width="20"/>
        <t:dgCol title="funcType" field="functionType" treefield="functionType" replace="funcType.page_0,funcType.from_1" width="20"/>
        <t:dgCol title="menu.url" field="functionUrl" treefield="src" width="50"/>
        <t:dgCol title="menu.order" field="functionOrder" treefield="order" width="20"/>
        <t:dgCol title="menu.funiconstyle" field="functionIconStyle" treefield="iconStyle" width="20"/>
    </t:datagrid>
</div>
</div>
