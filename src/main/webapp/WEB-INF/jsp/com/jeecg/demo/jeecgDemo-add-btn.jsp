  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jeecgListDemoController.do?doAdd" >
		...
		<table style="width: 500px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="age" name="age" type="text" style="width: 150px" class="inputxt" datatype="d"/>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="depId" type="list"
									dictTable="t_s_depart" dictField="id" dictText="departname" defaultVal="${jeecgDemoPage.depId}" hasLabel="false"  title="部门" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="sex" type="radio"
									typeGroupCode="sex" defaultVal="${jeecgDemoPage.sex}" hasLabel="false"  title="性别" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="status" type="list"
									typeGroupCode="sf_yn" defaultVal="N" hasLabel="false"  title="入职状态" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						<t:webUploader auto="true" name="fujian"></t:webUploader>
					</td>
				</tr>
