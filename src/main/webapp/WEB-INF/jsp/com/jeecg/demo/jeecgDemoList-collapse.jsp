...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgDemoCollapseList" onLoadSuccess="optsMenuToggle" checkbox="true" pagination="true" fitColumns="true" title="操作列折叠demo" actionUrl="jeecgListDemoController.do?datagrid" idField="id" fit="true" queryMode="group">
    ...
    <t:dgCol title="年龄"  extend="{style:'width:50px'}" field="age"  query="true" width="120" queryMode="group"/>
    ...
    <t:dgCol title="性别"  field="sex"  query="false" showMode="radio" dictionary="sex" width="120"/>
    ...
    <t:dgCol title="操作" field="opt" width="100" formatterjs="collapseOptionMenu"/>
  </t:datagrid>
  </div>
 </div>
