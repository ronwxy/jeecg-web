...
<t:datagrid title="日志" name="logList" actionUrl="jeecgListDemoController.do?logDatagrid" 
	...
	<t:dgCol title="日志类型" field="operatetype" replace="登录_1,退出_2,插入_3,删除_4,更新_5,上传_6,其他_7"/>
	<t:dgCol title="log.content" field="logcontent" width="340"/>
	<t:dgCol title="operate.ip" field="note" width="200"/>
	<t:dgCol title="操作人ID" field="TSUser.userName" width="200"/>
	<t:dgCol title="操作人名" field="TSUser.realName" width="200"/>
	<t:dgCol title="浏览器" field="broswer" width="100"/>
	<t:dgCol title="operate.time" field="operatetime" formatter="yyyy-MM-dd hh:mm:ss" width="200"/>
	
	 <t:dgToolBar title="数据报表" icon="icon-search" url="jeecgListDemoController.do?goOnlyData" funname="goBaobiao"/>
	 <t:dgToolBar title="图形报表" icon="icon-search" url="jeecgListDemoController.do?goChart" funname="goBaobiao2"/>
