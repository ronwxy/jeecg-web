...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgMinidaoList"  pageSize="500" pagination="false" fitColumns="false" title="用户操作统计报表" actionUrl="jeecgListDemoController.do?logrpDatagrid" idField="id" fit="true" queryMode="group">
    ...
    <t:dgCol title="用户" align="center" field="name" width="120"/>
    <t:dgCol title="登陆次数" align="center" field="loginct" width="120"/>
    <t:dgCol title="退出次数" align="center" field="outct" width="120"/>
    <t:dgCol title="修改次数" align="center" field="xgct" width="120"/>
    <t:dgCol title="操作次数" align="center" field="ct" width="120"/>
  </t:datagrid>
  </div>
 </div>