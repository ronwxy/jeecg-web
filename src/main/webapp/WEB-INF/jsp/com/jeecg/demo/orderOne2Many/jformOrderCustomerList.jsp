	...
	<c:if test="${fn:length(jformOrderCustomerList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
							<t:dictSelect field="jformOrderCustomerList[0].sex" type="radio"  datatype="*"   typeGroupCode="sex"  defaultVal="${jformOrderCustomerPage.sex}" hasLabel="false"  title="性别"/>
		...
		<c:forEach items="${jformOrderCustomerList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" /></td>
				   ...
				   <td align="left">
							<t:dictSelect field="jformOrderCustomerList[${stuts.index }].sex" type="radio"  datatype="*"   typeGroupCode="sex"  defaultVal="${poVal.sex }" hasLabel="false"  title="性别"/>
					  <label class="Validform_label" style="display: none;">性别</label>
				   </td>
				   <td align="left">
