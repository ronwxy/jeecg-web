...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jformOrderCustomerList" checkbox="true" fitColumns="true" title="" actionUrl="jformOrderMainController.do?customerDatagrid" 
   ...
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="0"/>
   <t:dgCol title="外键"  field="fkId"  hidden="true"  queryMode="single"  width="0"/>
   <t:dgCol title="名称"  field="name"  extendParams="editor:'text'" queryMode="single"  width="100"/>
   <t:dgCol title="单价"  field="money" extendParams="editor:'numberbox'"  queryMode="single"  width="50"/>
   <t:dgCol title="性别"  field="sex" extendParams="editor:'combobox'" queryMode="single" dictionary="sex"  width="80"/>
   <t:dgCol title="电话"  field="telphone" extendParams="editor:{type:'validatebox',options:{validType:'phoneRex'}}"  queryMode="single"  width="120"/>
   <t:dgCol title="身份证扫描件"  field="sfPic"  queryMode="single"  width="120"/>
   
	<t:dgToolBar  title="编辑" icon="icon-edit"  funname="editRow"/>
	<t:dgToolBar  title="保存" icon="icon-save" url="jformOrderMainController.do?saveRows" funname="saveData"/>
