...
<div class="easyui-layout" fit="true" id="lywidth_demo">
  ...
  <t:datagrid name="jformOrderMainList" checkbox="false" fitColumns="true" title="订单主信息" actionUrl="jformOrderMainController.do?datagrid" 
   ...
   <t:dgCol title="订单号"  field="orderCode"  queryMode="single" query="true"  width="120"/>
   <t:dgCol title="订单日期"  field="orderDate" formatter="yyyy-MM-dd" queryMode="single" query="true" width="120"/>
   <t:dgCol title="订单金额"  field="orderMoney"  queryMode="single" query="true" width="120"/>
   <t:dgCol title="备注"  field="content"  hidden="true"  queryMode="single" downloadName="附件下载"  width="120"/>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="jformOrderMainController.do?goAdd" funname="add" width="100%" height="100%"/>
   <t:dgToolBar title="编辑" icon="icon-edit" url="jformOrderMainController.do?goUpdate" funname="update" width="100%" height="100%"/>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="jformOrderMainController.do?doBatchDel" funname="deleteALLSelect"/>
   <t:dgToolBar title="导入数据" icon="icon-put" funname="ImportXls"/>
   <t:dgToolBar title="导出数据" icon="icon-putout" funname="ExportXls"/>
