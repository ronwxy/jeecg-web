...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		<t:datagrid name="jeecgDemoListquery" title="多条件动态查询" actionUrl="jeecgListDemoController.do?datagrid" idField="id" queryMode="group" checkbox="true"
			...
			<t:dgCol title="用户名" field="name" query="false"/>
			<t:dgCol title="个人介绍" field="content" query="false"/>
			<t:dgCol title="办公电话" field="phone" query="false"/>
			<t:dgCol title="创建日期" field="createDate" formatter="yyyy-MM-dd" query="false" queryMode="group"/>
			<t:dgCol title="邮箱" field="email" query="false"/>
			<t:dgCol title="年龄" sortable="true" field="age" query="false"/>
			<t:dgCol title="工资" field="salary" query="false"/>
			<t:dgCol title="生日" field="birthday" formatter="yyyy/MM/dd" query="false"/>
		</t:datagrid>
