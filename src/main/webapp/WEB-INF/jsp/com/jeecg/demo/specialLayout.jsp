...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
	  <t:datagrid name="jeecgrowList" pagination="true" fitColumns="true" title="数据列表" actionUrl="jeecgListDemoController.do?datagrid" pageSize="5" idField="id" queryMode="group">
		<t:dgCol title="id"  field="id"   hidden="true"   queryMode="group"  width="140"/>
	    <t:dgCol title="名称"  field="name" query="true" extendParams="editor:'text'" width="150"/>
	    <!--update-begin-Author:zhangweijian Date: 20180710 for：TASK #2941 【bug】常用示例，小问题，年龄改为区间查询-->
	    <t:dgCol title="年龄"  field="age"  query="true" extendParams="editor:'numberbox'" width="80" queryMode="group"/>
	    <!--update-end-Author:zhangweijian Date: 20180710 for：TASK #2941 【bug】常用示例，小问题，年龄改为区间查询-->
	    <t:dgCol title="生日"  field="birthday" formatter="yyyy-MM-dd"  extendParams="editor:'datebox'" width="150"/>
	    <t:dgCol title="性别"  field="sex"  query="true" dictionary="sex" extendParams="editor:'combobox'" width="100"/>
	    <t:dgCol title="工资"  field="salary"  queryMode="group" extendParams="editor:'numberbox'" width="100"/>
	    <t:dgCol title="入职状态"  field="status" query="true" dictionary="sf_yn" extendParams="editor:'combobox'" width="100"/>
	    <t:dgCol title="个人介绍"  field="content"  hidden="true"   queryMode="group"  width="500" extendParams="editor:'text'" />
          ...
          <%-- <t:dgFunOpt funname="showEdit(id,name)" title="common.edit" urlclass="ace_button"  urlfont="fa-trash-o"/> --%>
		...
		<t:formvalid formid="ff" dialog="true" layout="table" tiptype="4" action="jeecgListDemoController.do?saveRows">
			...
			<table style="width: 600px;margin-bottom:75px" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
							<t:dictSelect field="demos[0].sex" typeGroupCode="sex" id="sex" title="性别"/>
						</td>
						<td align="right">
							<label class="Validform_label">
								工资:
						...
						<td class="value">
							<t:dictSelect field="demos[0].status" id="status" typeGroupCode="sf_yn" title="入职状态"/>
						</td>
					</tr>
					<tr>
						<td align="right">
