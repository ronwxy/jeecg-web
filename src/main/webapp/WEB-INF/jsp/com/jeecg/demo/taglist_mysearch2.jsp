...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgMysearchList" pageSize="500" checkbox="true" pagination="true" fitColumns="false" title="自定义列表查询条件二" actionUrl="jeecgListDemoController.do?datagrid" idField="id" fit="true">
    ...
    <t:dgCol title="名称"  field="name" autocomplete="true" width="200"  />
    <t:dgCol title="年龄"  field="age"  width="120" />
    <t:dgCol title="生日"  field="birthday" formatter="yyyy-MM-dd" width="200"/>
    <t:dgCol title="部门"  field="depId" dictionary="t_s_depart,id,departname" width="120"/>
    <t:dgCol title="性别"  field="sex"  dictionary="sex" width="120"/>
    <t:dgCol title="电话"  field="phone"  width="200"/>
    <t:dgCol title="工资"  field="salary"  width="200"/>
  </t:datagrid>
