...
<table style="display: none">
	<tbody id="add_cgDynamGraphConfigItem_table_template">
		<tr>
			...
			<td align="left"><t:dictSelect field="cgDynamGraphConfigItemList[#index#].fieldType" extendJson="{style:'width:80px'}" type="list" typeGroupCode="fieldtype" defaultVal="String" hasLabel="false" title="common.text.type"/></td>
			...
			<td align="left"><t:dictSelect field="cgDynamGraphConfigItemList[#index#].SMode"  extendJson="{style:'width:90px'}" type="list" typeGroupCode="searchmode" defaultVal="" hasLabel="false" title="common.query.module"/></td>
			...
			<td align="left"><t:dictSelect field="cgDynamGraphConfigItemList[#index#].SFlag"  extendJson="{style:'width:90px'}" type="list" typeGroupCode="yesorno" defaultVal="" hasLabel="false" title="common.isquery"/></td>
		</tr>
	</tbody>
</table>
<table style="display: none">
