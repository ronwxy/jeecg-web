...
<div region="center" style="padding:0px;border:0px"><t:datagrid name="cgformFtlList" title="表单模板列表" actionUrl="cgformFtlController.do?datagrid&cgformId=${formid}" idField="id" fit="true">
	...
	<t:dgCol title="版本号" field="ftlVersion"/>
    ...
    <t:dgFunOpt funname="ftleditor(id,cgformName)" title="模板编辑" urlclass="ace_button" urlfont="fa-edit"/>
	<t:dgToolBar title="Word模板上传" icon="icon-add" url="cgformFtlController.do?addorupdate&cgformId=${formid}" funname="add"/>
</t:datagrid></div>
</div>
