...
<div region="center" style="padding:0px;border:0px"><t:datagrid name="cgformFtlList" title="表单模板列表" actionUrl="cgformFtlController.do?datagrid&cgformId=${formid}" idField="id" fit="true">
	...
	<t:dgCol title="表单ID" field="cgformId" hidden="true"/>
	<t:dgCol title="模板编号" field="ftlVersion"/>
	<t:dgCol title="模板名称" field="cgformName"/>
	<t:dgCol title="激活状态" field="ftlStatus" replace="未激活_0,已激活_1"/>
	<t:dgCol title="word路径" field="ftlWordUrl"/>
    ...
    <t:dgFunOpt funname="preview(cgformName,ftlVersion)" title="模板预览" urlclass="ace_button" urlfont="fa-search"/>
	<t:dgToolBar title="创建模板" icon="icon-add" funname="add" width="100%" url="cgformFtlController.do?addorupdate&cgformId=${formid}" height="100%"/>
	<%-- 
	<t:dgToolBar title="自定义布局模板" icon="icon-add" funname="add" url="cgformFtlController.do?addorupdate&editorType=02&cgformId=${formid}" width="100%" height="100%"/>
	--%>
	<t:dgToolBar title="模板编辑" icon="icon-edit" funname="update" url="cgformFtlController.do?addorupdate&cgformId=${formid}" width="100%" height="100%"/>
	<t:dgToolBar title="上传Word模板" icon="icon-add" funname="add" url="cgformFtlController.do?addorupdate&editorType=03&cgformId=${formid}"/>
</t:datagrid></div>
