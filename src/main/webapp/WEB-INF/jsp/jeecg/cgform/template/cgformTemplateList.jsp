...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="cgformTemplateList" checkbox="true" fitColumns="true" title="Online表单风格列表" actionUrl="cgformTemplateController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="所属部门"  field="sysOrgCode"  hidden="true"  queryMode="single"  width="120"/>
   <t:dgCol title="所属公司"  field="sysCompanyCode"  hidden="true"  queryMode="single"  width="120"/>
   <t:dgCol title="表单风格名"  field="templateName"   query="true" queryMode="single"  width="120"/>
   <t:dgCol title="风格编码"  field="templateCode"   query="true" queryMode="single"  width="120"/>
   <t:dgCol title="类型"   field="templateType"   query="true" queryMode="single" replace="单表_1,主子表_2,通用模板_3" width="120"/>
   <t:dgCol title="是否共享" hidden="true"  field="templateShare" query="false" queryMode="single" dictionary="sf_yn" width="120"/>
    <t:dgCol title="是否激活"   field="status" replace="有效_1,无效_0"  query="true" queryMode="single"  width="120"/>
   <t:dgCol title="预览图"  field="templatePic"   image="true"  imageSize="30,30" queryMode="single"  width="120"/>
   <t:dgCol title="风格描述"  field="templateComment"   query="true" queryMode="single"  width="120"/>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="cgformTemplateController.do?goAdd" funname="add" width="900" height="500"/>
   <t:dgToolBar title="编辑" icon="icon-edit" url="cgformTemplateController.do?goUpdate" funname="update" width="900" height="500"/>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="cgformTemplateController.do?doBatchDel" funname="deleteALLSelect"/>
   <t:dgToolBar title="查看" icon="icon-search" url="cgformTemplateController.do?goUpdate" funname="detail"  width="900" height="500"/>
   <%-- 
   <t:dgToolBar title="导入" icon="icon-put" funname="ImportXls"/>
   <t:dgToolBar title="导出" icon="icon-putout" funname="ExportXls"/>
    --%>
   <t:dgToolBar title="模板下载" icon="icon-putout"   funname="downloadTemplate"/>
