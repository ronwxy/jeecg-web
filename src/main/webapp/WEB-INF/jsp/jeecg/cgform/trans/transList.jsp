...
<t:datagrid name="transList" title="smart.form.setting" fitColumns="false" pagination="false" checkbox="true" fit="true" queryMode="group" actionUrl="cgformTransController.do?datagrid" idField="id" sortName="id">
	<t:dgCol title="table.name" field="id" query="true" width="300"/>
	<t:dgToolBar id="generateForm" title="generate.form" icon="icon-edit"  url="cgformTransController.do?transEditor" funname="dataEditor"/>
</t:datagrid>
</div>
</div>
