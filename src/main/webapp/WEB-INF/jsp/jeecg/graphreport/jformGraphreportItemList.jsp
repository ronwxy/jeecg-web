				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/>
				  ...
				  <td align="left" style="width: 120px;">
							<t:dictSelect field="fieldType" extendJson="{style:'width:100px'}"
										typeGroupCode="fieldtype" defaultVal="${jformGraphreportItemPage.fieldType}" hasLabel="false"  title="字段类型"/>
				  ...
				  <td align="left">
							<t:dictSelect field="isShow" type="list" extendJson="{style:'width:100px'}"
										typeGroupCode="sf_yn" defaultVal="${jformGraphreportItemPage.isShow}" hasLabel="false"  title="是否显示"/>
				  ...
				  <td align="left">
							<t:dictSelect field="searchFlag" type="list" extendJson="{style:'width:100px'}"
										typeGroupCode="sf_yn" defaultVal="${jformGraphreportItemPage.searchFlag}" hasLabel="false"  title="是否查询"/>
				  ...
				  <td align="left">
							<t:dictSelect field="searchMode" type="list" extendJson="{style:'width:100px'}"
										typeGroupCode="searchmode" defaultVal="${jformGraphreportItemPage.searchMode}" hasLabel="false"  title="查询模式"/>
				  ...
				  <td align="left">
							<t:dictSelect field="isGraph" type="list" extendJson="{style:'width:100px'}"
										typeGroupCode="sf_yn" defaultVal="${jformGraphreportItemPage.isGraph}" hasLabel="false"  title="显示图表"/>
				  ...
				  <td align="left">
							<t:dictSelect field="graphType" type="list" extendJson="{style:'width:100px'}"
										typeGroupCode="tblx" defaultVal="${jformGraphreportItemPage.graphType}" hasLabel="false"  title="图表类型"/>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" />
				   ...
				   <td align="left">
							<t:dictSelect field="jformGraphreportItemList[${stuts.index }].isGraph" type="list" extendJson="{style:'width:100px'}"
										typeGroupCode="sf_yn" defaultVal="${poVal.isGraph }" hasLabel="false"  title="显示图表"/>
					  <label class="Validform_label" style="display: none;">显示图表</label>
				   </td>
				   <td align="left">
							<t:dictSelect field="jformGraphreportItemList[${stuts.index }].graphType" type="list" extendJson="{style:'width:100px'}"
										typeGroupCode="tblx" defaultVal="${poVal.graphType }" hasLabel="false"  title="图表类型"/>
					  <label class="Validform_label" style="display: none;">图表类型</label>
				   </td>
				   <td align="left">
