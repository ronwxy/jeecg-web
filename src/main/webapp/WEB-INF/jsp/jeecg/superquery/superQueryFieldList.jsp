	...
	<c:if test="${fn:length(superQueryFieldList)  <= 0 }">
			<tr data-index="0">
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
							<t:dictSelect field="superQueryFieldList[0].ctype" type="list"   typeGroupCode="field_type"  defaultVal="${superQueryFieldPage.ctype}" hasLabel="false"  datatype="*" title="字段类型"/>
					  <label class="Validform_label" style="display: none;">字段类型</label>
					</td>
				  <td align="left">
							<t:dictSelect field="superQueryFieldList[0].stype" type="list"   typeGroupCode="s_type"  defaultVal="${superQueryFieldPage.stype}" hasLabel="false" datatype="*" title="控件类型"/>
		...
		<c:forEach items="${superQueryFieldList}" var="poVal" varStatus="stuts">
			<tr data-index="${stuts.index }">
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" /></td>
				   ...
				   <td align="left">
							<t:dictSelect field="superQueryFieldList[${stuts.index }].ctype" type="list"   typeGroupCode="field_type"  defaultVal="${poVal.ctype }" hasLabel="false"  title="字段类型"/>
					  <label class="Validform_label" style="display: none;">字段类型</label>
				   </td>
				   <td align="left">
							<t:dictSelect field="superQueryFieldList[${stuts.index }].stype" type="list"   typeGroupCode="s_type"  defaultVal="${poVal.stype }" hasLabel="false"  title="控件类型"/>
					  <label class="Validform_label" style="display: none;">控件类型</label>
				   </td>
				   <td align="left">
