...
<div data-options="region:'east',split:true" title="用户选择" style="width:200px;">
    ...
    <input type="hidden" id="groupId" name="groupId" value="${groupId}">
        <t:datagrid checkbox="false" name="userList1" title="common.user.select" actionUrl="departAuthGroupController.do?getUserDataGrid&groupId=${groupId}"
            ...
            <t:dgCol title="common.id" field="id" hidden="true" sortable="false" />
            <t:dgCol title="common.username" width="150" sortable="false" field="userName" query="true"/>
            <t:dgCol title="common.real.name" width="150" field="realName" query="true"/>
        </t:datagrid>
    </div>
</div>
