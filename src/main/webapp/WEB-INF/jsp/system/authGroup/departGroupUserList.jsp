...
<t:datagrid name="userList" title="common.operation" actionUrl="departAuthGroupController.do?getDepartGroupUser&groupId=${groupId}" fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" sortOrder="asc,desc">
	...
	<t:dgCol title="common.role" field="roles" width="100"/>
	<t:dgCol title="common.operation" field="opt" width="100"/>
    <t:dgFunOpt funname="deleteDialog(userName)" title="common.delete" urlclass="ace_button" urlfont="fa-trash-o"/>
    ...
    <t:dgFunOpt funname="openSelectRoles(id)" title="分配角色" urlclass="ace_button" urlfont="fa fa-book"/>
</t:datagrid>
