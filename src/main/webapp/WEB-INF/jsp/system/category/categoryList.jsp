...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="categoryList" title="menu.sort.management"
			...
			<t:dgCol title="common.type.name" field="name" treefield="text" width="300"/>
			<t:dgCol title="common.icon" field="TSIcon_iconPath" treefield="code"
				image="true" hidden="true"/>
			<t:dgCol title="common.type.code" field="code" treefield="id"/>
			...
			<t:dgToolBar icon="icon-add" title="common.add"
				url="categoryController.do?addorupdate" funname="addCategory"/>
			<t:dgToolBar icon="icon-edit" title="common.edit"
				url="categoryController.do?addorupdate" funname="updateCategory"/>
		</t:datagrid>
	</div>
</div>
