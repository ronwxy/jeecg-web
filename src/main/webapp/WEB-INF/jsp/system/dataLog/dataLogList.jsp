...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="datalogList" checkbox="true" fitColumns="true" title="数据日志" actionUrl="systemController.do?datagridDataLog" idField="id" fit="true" queryMode="group">
			...
			<t:dgCol title="表名" field="tableName" colspan="2" query="true" queryMode="single" width="100" extend="{style:{width:'150px'}}"/>
			<t:dgCol title="数据ID" field="dataId" queryMode="single" query="true" width="230" extend="{style:{width:'300px'}}"/>
			<t:dgCol title="版本号" field="versionNumber" queryMode="single" width="45"/>
			<t:dgCol title="数据内容" field="dataContent" queryMode="single" width="400"/>
			<t:dgCol title="创建人" field="createName" hidden="true" queryMode="single" width="100"/>
			<t:dgCol title="创建人" field="createBy" hidden="false" queryMode="single" width="100"/>
			...
			<t:dgCol title="所属部门" dictionary="t_s_depart,org_code,departname" field="sysOrgCode" hidden="ture" queryMode="single" width="120"/>
			<t:dgCol title="所属公司" dictionary="t_s_depart,org_code,departname" field="sysCompanyCode" hidden="false" queryMode="single" width="120"/>
            ...
            <t:dgFunOpt funname="popDataContent(id)" title="复制数据" urlclass="ace_button" urlfont="fa-copy"/>
			<!-- update-end--Author:zhangjq  Date:20160904 for：[1342]【系统图标统一调整】讲{消息中间件}{系统监控}的链接按钮，改成ace风格的-->
			<t:dgToolBar title="数据比较" funname="dataDiff" icon="icon-search"/>
		</t:datagrid>
	</div>
 </div>
