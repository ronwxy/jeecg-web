...
<div region="center" style="padding:0px;border:0px">
	<t:datagrid name="functionList" title="menu.manage" actionUrl="functionController.do?functionGrid" idField="id" fit="true" fitColumns="true" treegrid="true" pagination="false" btnCls="bootstrap btn btn-normal btn-xs">
        ...
        <t:dgCol title="menu.name" field="functionName" treefield="text" width="40"/>
        <t:dgCol title="common.icon" field="TSIcon_iconPath" treefield="code" image="true" />
        <t:dgCol title="funcType" field="functionType" treefield="functionType" replace="funcType.page_0,funcType.from_1" width="20"/>
        <t:dgCol title="menu.url" field="functionUrl" treefield="src" width="80"/>
        <t:dgCol title="menu.order" field="functionOrder" treefield="order"/>
        <t:dgCol title="menu.funiconstyle" field="functionIconStyle" treefield="iconStyle" width="25"/>
        <t:dgCol title="common.operation" field="opt" width="100"/>
        <t:dgFunOpt funname="delMenu(id)" title="common.delete" urlclass="ace_button"
                    urlStyle="background-color:#ec4758;" urlfont="fa-trash-o"/>
        <t:dgFunOpt funname="operationDetail(id)" title="button.setting" urlclass="ace_button" urlfont="fa-cog"/>
        <t:dgFunOpt funname="operationData(id,src)" title="数据规则" urlclass="ace_button"
                    urlStyle="background-color:#1a7bb9;" urlfont="fa-database"/>
        <t:dgToolBar title="common.add.param" langArg="common.menu" icon="fa fa-plus" url="functionController.do?addorupdate" height="400" funname="addFun"/>
        <t:dgToolBar title="common.edit.param" langArg="common.menu" icon="fa fa-edit" url="functionController.do?addorupdate" height="490" funname="update"/>
    </t:datagrid>
</div>
</div>
