...
<t:datagrid title="log.manage" name="logList" actionUrl="logController.do?datagrid" idField="id" sortName="operatetime" sortOrder="desc" pageSize="500" extendParams="view:scrollview">
	...
	<t:dgCol title="log.content" field="logcontent" width="200"/>
	<t:dgCol title="operate.ip" field="note" width="200"/>
	<t:dgCol title="操作人ID" field="username" width="200"/>
	<t:dgCol title="操作人名" field="realname" width="200"/>
	<t:dgCol title="(推荐使用IE8+,<br>谷歌浏览器可以获得更快,<br>更安全的页面响应速度) " field="broswer" width="100"/>
