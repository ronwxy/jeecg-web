...
<%@include file="/WEB-INF/jsp/context/mytags.jsp"%>
  <t:datagrid name="noticeAuthorityRoleList" checkbox="true" fitColumns="false" title="common.authority.role" actionUrl="noticeAuthorityRoleController.do?datagrid&noticeId=${noticeId}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="通告ID"  field="noticeId"  hidden="true"  queryMode="group"  width="120"/>
   <t:dgCol title="common.role.name"  field="role.roleName"  hidden="false"  queryMode="group"  width="180"/>
   ...
   <t:dgToolBar title="common.authority.role" icon="icon-add" url="noticeAuthorityRoleController.do?doSave" funname="addAuthorityRole"/>
  </t:datagrid>
