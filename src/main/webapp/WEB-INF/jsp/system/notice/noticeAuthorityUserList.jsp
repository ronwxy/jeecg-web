...
<%@include file="/WEB-INF/jsp/context/mytags.jsp"%>
  <t:datagrid name="noticeAuthorityUserList" checkbox="true" fitColumns="false" title="common.authority.user" actionUrl="noticeAuthorityUserController.do?datagrid&noticeId=${noticeId}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="common.username"  field="user.userName"  hidden="false"  queryMode="group"  width="180"/>
   ...
   <t:dgToolBar title="common.authority.user" icon="icon-add" url="noticeAuthorityUserController.do?doSave" funname="addAuthorityUser"/>
  </t:datagrid>
