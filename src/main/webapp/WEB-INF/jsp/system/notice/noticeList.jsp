...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="noticeList" title="common.notice" actionUrl="noticeController.do?datagrid" idField="id" fit="true" sortName="createTime" sortOrder="desc">
   ...
   <t:dgCol title="状态" field="isRead" width="40" replace="已读_1,未读_0"/>
   <t:dgCol title="标题" field="noticeTitle" width="120"/>
   <t:dgCol title="时间" field="createTime" formatter="yyyy-MM-dd hh:mm" width="80"/>
   <t:dgCol title="common.operation" field="opt" width="40"/>
