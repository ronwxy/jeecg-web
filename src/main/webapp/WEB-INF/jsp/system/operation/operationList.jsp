...
<t:datagrid name="operationList" title="operate.manage" actionUrl="functionController.do?opdategrid&functionId=${functionId}" idField="id">
	...
	<t:dgCol title="operate.name" field="operationname" width="100"/>
	<t:dgCol title="operate.code" field="operationcode"/>
	<t:dgCol title="common.type" field="operationType" replace="common.hide_0,operationType.disabled_1"/>
<%-- 	<t:dgCol title="common.status" field="status" replace="common.enable_0,common.disable_1"/> --%>
<%--     <t:dgCol title="permission.name" field="TSFunction_functionName"/> --%>
	...
	<t:dgToolBar title="common.add.param" langArg="common.operation" icon="icon-add" url="functionController.do?addorupdateop&functionId=${functionId}" funname="add"/>
</t:datagrid>
