...
<div id="divUserList" class="easyui-layout" style="width:100%;">
	...
	<t:datagrid name="departUserList" title="common.operation"
		...
		<t:dgCol title="common.real.name" field="realName" query="true" width="100"/>
		...
		<t:dgToolBar title="common.add.param" langArg="common.user" icon="icon-add" url="userController.do?addorupdateMyOrgUser&departid=${departid}" funname="add"/>
		<t:dgToolBar title="common.edit.param" langArg="common.user" icon="icon-edit" url="userController.do?addorupdateMyOrgUser&departid=${departid}" funname="update"/>
		<t:dgToolBar title="添加已有用户" icon="icon-add" url="organzationController.do?goAddUserToOrg&orgId=${departid}" funname="add" width="650"/>
	</t:datagrid>
 </div>
</div>
