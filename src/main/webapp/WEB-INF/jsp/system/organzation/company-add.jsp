		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						...
						<input type="radio" value="1" name="orgType" id="orgType" checked="checked"/><label
							for="orgType">公司</label>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						...
						<input type="radio" value="default" name="homePage" id="default"/><label
							for="default">默认</label>
						<input type="radio" value="kindergarten" name="homePage" id="kindergarten"/><label
							for="kindergarten">幼儿园</label>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">首页</label>
					</td>
				</tr>
			<tr>
				<td align="right">
