 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" callback="@Override callbackOrg" action="systemController.do?saveDepart" >
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
            ...
            <c:if test="${param.kindergartenFlag}">
                <tr>
                    <td align="right">
                        <label class="Validform_label">
                            首页:
                    ...
                    <td class="value">
                        ...
                        <input type="radio" value="kindergarten" name="homePage"
                               id="kindergarten" ${homePage=='kindergarten'?'checked':''}/><label
                            for="kindergarten">幼儿园</label>
                        <input type="radio" value="default" name="homePage"
                               id="default" ${homePage=='default'?'checked':''}/><label
