...
<t:datagrid name="functionList" title="permission.manage" actionUrl="roleController.do?setOperate&roleId=${roleId}" idField="functionid" treegrid="true" pagination="false">
	...
	<t:dgCol title="permission.name" field="functionName" width="100" treefield="text"/>
	<t:dgCol title="common.operation" field="TOperations" width="300" treefield="operations"/>
</t:datagrid>
