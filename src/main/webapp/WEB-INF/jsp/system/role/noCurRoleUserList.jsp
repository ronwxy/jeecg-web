...
<div id="main_role_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="noCurRoleUserList" title="common.operation"
            ...
            <t:dgCol title="common.username" sortable="false" field="userName" width="100" query="true"/>
            ...
            <t:dgCol title="common.status" sortable="true" field="status" width="100" replace="common.active_1,common.inactive_0,super.admin_-1"/>
        </t:datagrid>
    </div>
</div>
