  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSSmsController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						        <t:dictSelect field="esType" typeGroupCode="msgType" hasLabel="false" defaultVal="${tSSmsPage.esType}"/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     <t:dictSelect field="esStatus" typeGroupCode="msgStatus" hasLabel="false" defaultVal="${tSSmsPage.esStatus}"/>
							<span class="Validform_checktip"></span>
