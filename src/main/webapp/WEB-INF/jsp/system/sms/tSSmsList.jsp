...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSSmsList" checkbox="true" fitColumns="false" title="common.messageSend.record" actionUrl="tSSmsController.do?datagrid" idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc">
   ...
   <t:dgCol title="common.messageType"  field="esType"  query="true" queryMode="single" dictionary="msgType"/>
   ...
   <t:dgCol title="common.receiver"  field="esReceiver"  queryMode="single"/>
   <t:dgCol title="common.content_2"  field="esContent"  queryMode="single" />
   <t:dgCol title="common.dateCreated"  field="createDate" formatter="yyyy-MM-dd hh:mm:ss" query="true" queryMode="group" />
   <t:dgCol title="common.sendtime"  field="esSendtime"  formatter="yyyy-MM-dd hh:mm:ss" queryMode="single" />
   <t:dgCol title="common.sendState"  field="esStatus" query="true"  queryMode="single" dictionary="msgStatus"  />
   <t:dgCol title="common.remark"  field="remark"  queryMode="single" />
   <t:dgToolBar title="common.iconEdit" icon="icon-edit" url="tSSmsController.do?goUpdate" funname="update"/>
  </t:datagrid>
  </div>
 </div>
