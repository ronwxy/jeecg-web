...
<div region="center" style="padding:0px;border:0px">
	<t:datagrid name="interfaceList" title="接口权限管理" actionUrl="interfaceController.do?interfaceGrid" idField="id" treegrid="true" pagination="false" btnCls="bootstrap btn btn-normal btn-xs">
        ...
        <t:dgCol title="接口权限名称" field="interfaceName" treefield="text" width="100"/>
        <t:dgCol title="接口权限编码" field="interfaceCode" treefield="interfaceCode" width="100" formatterjs="getInterfaceCode"/>
        <t:dgCol title="接口权限地址" field="interfaceUrl" treefield="src" width="80"/>
        <t:dgCol title="请求方式" field="interfaceMethod" treefield="interfaceMethod" width="100" formatterjs="getInterfaceMethod"/>
        <t:dgCol title="排序" field="interfaceOrder" treefield="order" width="50"/>
        ...
        <t:dgFunOpt funname="operationData(id)" title="接口权限规则" urlclass="ace_button"
                    urlStyle="background-color:#1a7bb9;" urlfont="fa-database"/>
        <t:dgToolBar title="接口权限录入" langArg="common.menu" icon="fa fa-plus" url="interfaceController.do?addorupdate" height="400" funname="addFun"/>
        <t:dgToolBar title="接口权限编辑" langArg="common.menu" icon="fa fa-edit" url="interfaceController.do?addorupdate" height="490" funname="update"/>
    </t:datagrid>
</div>
</div>
