...
<div id="main_typegroup_list" class="easyui-layout" fit="true">  
    <div region="center" style="padding:0px;border:0px">
        ...
        idField="id" treegrid="false" pagination="false"  sortOrder="desc" sortName="createDate" onLoadSuccess="loadSuccess" queryMode="group" btnCls="bootstrap btn btn-info btn-xs">
            ...
            <t:dgCol title="dict.name" field="typegroupname" width="100" query="true"/>
            <t:dgCol title="dict.code" field="typegroupcode" width="100" treefield="code" query="true"/>
            ...
            <t:dgFunOpt funname="queryTypeValue(id)" title="common.type.view" urlclass="ace_button"
                        urlfont="fa-search"/>
            <t:dgToolBar title="common.add.param" langArg="lang.dictionary.type" icon="fa fa-plus" url="systemController.do?aouTypeGroup" funname="add"/>
            <%--<t:dgToolBar title="common.add.param" langArg="lang.dictionary.value" icon="icon-add" funname="typeGridTree_AddType"/>--%>
            <t:dgToolBar title="common.edit" icon="fa fa-edit" url="systemController.do?aouTypeGroup" funname="update"/>
            <t:dgToolBar title="common.refreshType" icon="fa fa-refresh" url="systemController.do?refreshTypeGroupAndTypes" funname="doSubmit"/>
        </t:datagrid>
    </div>
</div>
