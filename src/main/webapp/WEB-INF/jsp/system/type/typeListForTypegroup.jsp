...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="typeValueList" title="common.type.list"
            ...
            <t:dgCol title="common.type.name" field="typename"/>
            <t:dgCol title="common.type.code" field="typecode"/>
            <t:dgCol title="dict.order" field="orderNum"/>
            ...
            <t:dgToolBar title="common.add.param" langArg="common.type" icon="icon-add" url="systemController.do?addorupdateType&typegroupid=${typegroupid}" funname="add"/>
            <t:dgToolBar title="common.edit.param" langArg="common.type" icon="icon-edit" url="systemController.do?addorupdateType&typegroupid=${typegroupid}" funname="update"/>
        </t:datagrid>
    </div>
</div>
<script>
