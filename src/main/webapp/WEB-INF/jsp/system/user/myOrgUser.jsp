	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
		 ...
		 <%-- <tr>
            ...
            <td class="value">
                ...
                <t:dictSelect id="userType" field="userType" typeGroupCode="pms_usertype" hasLabel="false" defaultVal="${user.userType}"/>
        ...
        <%-- <tr>
            ...
            <td class="value">
                ...
                <t:dictSelect id="personType" field="personType" typeGroupCode="pms_persontype" hasLabel="false" defaultVal="${user.personType}"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr> --%>
        <tr>
            ...
            <td class="value">
                <t:dictSelect id="sex" field="sex" typeGroupCode="sex" hasLabel="false" defaultVal="${user.sex}" type="radio"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
		...
		<%-- <tr>
			...
			<td class="value" nowrap>
                ...
                <t:choose hiddenName="roleid" hiddenid="id" textname="roleName" url="userController.do?roles" name="roleList" icon="icon-search" title="common.role.list" isclear="true" isInit="true"/>
        ...
        <%-- <tr>
            ...
            <td class="value">
                ...
                <t:dictSelect id="devFlag" field="devFlag" typeGroupCode="dev_flag" hasLabel="false" defaultVal="${user.devFlag}" type="radio"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
        <tr>
