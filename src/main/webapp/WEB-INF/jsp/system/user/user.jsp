	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" nowrap>
                ...
                <t:choose hiddenName="roleid" hiddenid="id" textname="roleName" url="userController.do?roles"
                          name="roleList" icon="icon-search" title="common.role.list" isclear="true" isInit="true"/>
		...
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="email" value="${user.email}" validType="t_s_user,email,id" datatype="e"
                       errormsg="邮箱格式不正确!" ignore="ignore"/>
                <span class="Validform_checktip"></span>
            </td>
		</tr>
        <tr>
            ...
            <td class="value">
                ...
                <t:dictSelect id="devFlag" field="devFlag" typeGroupCode="dev_flag" hasLabel="false" defaultVal="${user.devFlag==null?'0':(user.devFlag)}" type="radio"/>
                <span class="Validform_checktip"></span>
            </td>
        </tr>
	</table>
